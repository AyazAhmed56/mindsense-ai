      ...
      <div className="hidden lg:flex flex-col justify-between flex-1 relative overflow-hidden bg-linear-to-br from-sky-600 via-sky-500 to-sky-400 p-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-[15px] leading-relaxed max-w-xs mb-10">
            Sign in to manage your projects, track tasks, and collaborate with
          ...
          <div className="flex flex-col gap-3">
            {[
              { icon: "◈", text: "All your projects in one dashboard" },
              { icon: "◎", text: "Real-time task & team updates" },
              { icon: "◇", text: "Powerful analytics and reports" },
            ].map((f) => (
              <div key={f.text} className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-lg bg-white/15 border border-white/25 flex items-center justify-center text-white text-xs shrink-0">
                  {f.icon}
                </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-sky-500 font-semibold cursor-pointer hover:text-sky-600 transition-colors">
                  Forgot password?
                </span>
              </div>
          ...
          <div className="flex items-center justify-center gap-5 mt-10">
            {[
              ...
              <span key={b} className="text-[11px] text-slate-400 font-medium">
                {b}
              </span>
            ))}
          </div>
